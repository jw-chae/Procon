"""Per-category build and evaluation pipeline for ProCon.

Reuses the frozen ProCon feature extractor, greedy-coreset builder, torch KNN
...
from procon.consensus.banks import build_consensus_banks, build_single_bank
from procon.consensus.experts import (
...
from procon.consensus.fusion import fuse_distances
from procon.consensus.local_covariance import (
    local_mahalanobis_bank,
    local_pca_residual_bank,
)
from procon.consensus.oob_pruning import prune_banks_oob
from procon.consensus.prototypes import intrinsic_prototype_refine
from procon.consensus.reliability import (
    compute_oob_reliability,
    compute_stability_reliability,
    reliability_to_penalty,
)
from procon.consensus.soft_projection import (
    auto_tau,
    soft_projection_bank,
    soft_projection_bank_multi,
    soft_projection_banks_vectorized,
)
from procon.consensus.v9_memory_selection import (
    build_rec_pruned_kcenter,
    build_recgreedy_memory,
)
from procon.data.gpu_transforms import preprocess_images, preprocess_masks
from procon.data.loaders import build_loader
from procon.engine import build_inference_backend
from procon.eval.metrics import image_metrics, pixel_metrics
from procon.postprocess.maps import blur_map, patches_to_map
from procon.utils import apply_runtime_settings, set_seed
...
def evaluate_category_layergroup(
    ...
    labels = None
    grid = None
    _timing = os.environ.get("PROCON_TIMING", "0") == "1"
